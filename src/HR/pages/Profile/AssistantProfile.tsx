    ...
    return (
        <div className="space-y-6 max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <Card className="md:col-span-1 border-indigo-100 shadow-xl shadow-indigo-50/50">
                    <div className="flex flex-col items-center">
                        <div className="relative mb-6">
                            <Avatar size="xl" alt="Assistant HR" className="ring-4 ring-indigo-50" />
                            <button
                                onClick={() => alert('Feature coming soon: Image upload')}
                                className="absolute bottom-0 right-0 p-2 bg-white rounded-full shadow-lg border border-gray-100 text-indigo-600 hover:text-indigo-700 transition-colors"
                            >
                                <Camera size={16} />
                            </button>
                        </div>
                    ...
                    <div className="mt-8 space-y-4 pt-8 border-t border-gray-50">
                        ...
                        <ul className="space-y-2 text-sm text-gray-600">
                            <li className="flex items-center gap-2 p-2 rounded-lg bg-gray-50">
                                <div className="h-5 w-5 bg-indigo-100 rounded flex items-center justify-center text-indigo-600 font-bold">✓</div>
                                Add Employees
                            </li>
                            <li className="flex items-center gap-2 p-2 rounded-lg bg-gray-50 text-gray-400">
                                <div className="h-5 w-5 bg-gray-100 rounded flex items-center justify-center font-bold text-gray-300 italic">×</div>
                    ...
                    <Card title="Change Password">
                        <form onSubmit={handlePasswordUpdate} className="space-y-4">
                            <div className="space-y-1.5">
                                ...
                                <input type="password" placeholder="••••••••" required className="w-full rounded-xl border-none ring-1 ring-gray-200 py-2 px-3 text-sm focus:ring-2 focus:ring-indigo-600 transition-all outline-none" />
                            </div>
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div className="space-y-1.5">
                            ...
                            <div className="pt-4">
                                <Button type="submit" variant="secondary" icon={<Lock size={18} />}>
                                    Update Password
                                </Button>
                            </div>
                        </form>
